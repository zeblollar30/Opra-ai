...
### The Concept: Phantom Wordmark
The logo is a **unified typographic mark** — the phantom mask is not a separate icon beside the text, but is *integrated into the letterforms themselves*. The word "opra" IS the logo. The mask emerges from within.

**The letter "O" IS the phantom mask:**
- A bold circular O — reads as a normal letter at first glance
- Inside the O's counter (the hollow space), two almond-shaped eye cutouts form the phantom mask's eyes
- The left eye contains a **play triangle** — "Opra performs / acts"
- The right eye drops a **phantom teardrop** — the emotional, human side; also reads as a musical note (opera/theatre nod)
- The O remains a clean, readable letter — the mask detail is an elegant discovery, not an obstacle to legibility

**"p", "r", "a"** — thick, bold geometric sans letters. Heavy strokes, clean contours, grounded and confident. The theater/masquerade reference is architectural: think heavy columns, proscenium arches, bold lettering on a playbill.

**Mask ribbons** — feather-light lines trailing from the sides of the O, barely perceptible, hinting at masquerade ties without distracting from the wordmark.

**Monochrome — black and white only.** The logo uses pure black (#000000) and pure white (#FFFFFF) exclusively. No gradients, no brand colors in the logo itself. This ensures maximum contrast, legibility, and versatility across any medium.
